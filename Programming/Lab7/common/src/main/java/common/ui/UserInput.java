...
import common.validators.AuthorizationValidator;
...
public class UserInput {
    ...
    public String readAccountExistenceSelect() {
        return inputRepeat("Do you have an account? (Y / N) ", SelectValidator.validateSelect, true);
    }

    public String readUsername() {
        return inputRepeat("Enter username: ", AuthorizationValidator.validateUsername, false);
    }

    public String readPasswd() {
        return inputRepeat("Enter password: ", AuthorizationValidator.validatePasswd, false);
    }
}
